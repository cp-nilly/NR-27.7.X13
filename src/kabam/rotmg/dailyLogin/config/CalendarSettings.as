...
public class CalendarSettings {
    ...
    public static function getCalendarModalRectangle(_arg1:int, _arg2:Boolean):Rectangle {
        var _local3:int = Math.ceil((_arg1 / NUMBER_OF_COLUMNS));
        return (new Rectangle(0, 0, ((((2 * DAILY_LOGIN_MODAL_PADDING) + (2 * DAILY_LOGIN_TABS_PADDING)) + (BOX_WIDTH * NUMBER_OF_COLUMNS)) + ((NUMBER_OF_COLUMNS - 1) * BOX_MARGIN)), ((((((TABS_HEIGHT + (2 * DAILY_LOGIN_TABS_PADDING)) + (2 * DAILY_LOGIN_MODAL_PADDING)) + (BOX_HEIGHT * _local3)) + ((_local3 - 1) * BOX_MARGIN)) + DAILY_LOGIN_MODAL_HEIGHT_MARGIN) + ((_arg2) ? 20 : 0))));
    }

    public static function getTabsRectangle(_arg1:int):Rectangle {
        var _local2:int = Math.ceil((_arg1 / NUMBER_OF_COLUMNS));
        return (new Rectangle(0, 0, (((BOX_WIDTH * NUMBER_OF_COLUMNS) + ((NUMBER_OF_COLUMNS - 1) * BOX_MARGIN)) + (2 * DAILY_LOGIN_TABS_PADDING)), (((BOX_HEIGHT * _local2) + ((_local2 - 1) * BOX_MARGIN)) + (2 * DAILY_LOGIN_TABS_PADDING))));
    }
