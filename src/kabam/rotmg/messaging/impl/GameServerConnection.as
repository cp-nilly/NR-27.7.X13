...
public class GameServerConnection {
    ...
    public static const MARKET_RESULT = 0;
    public static const TEXTBOX = 0;
    public static const TEXTBOX_BUTTON = 0;
    public static const SWITCH_MUSIC = 0;
    public static const BROADCAST = 0;
