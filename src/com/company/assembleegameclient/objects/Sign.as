...
public class Sign extends GameObject {
    ...
    override protected function getTexture(camera:Camera, currentMS:int):BitmapData {
        ...
        var bmdata:BitmapData = new BitmapDataSpy(txtField.width, txtField.height, true, 0);
        bmdata.draw(txtField);
        texture_ = TextureRedrawer.redraw(bmdata, size_, false, 0, true, 5 * Camera.vToS_scale / 50);
        return (texture_);
        txtField.text = signTxt.split("|").join("\n");
